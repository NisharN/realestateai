  ...
  return (
    <div className="relative z-20 bg-card border-t border-border">
      ...
      >
        <div
          className={cn(
            "flex items-end gap-1.5 max-w-3xl mx-auto rounded-2xl border bg-surface px-2 py-1.5 transition focus-within:ring-2 focus-within:ring-ring/30 focus-within:bg-card",
